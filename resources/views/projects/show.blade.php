                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h2 class="text-lg font-semibold text-gray-900">Teknologi</h2>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h2 class="text-lg font-semibold text-gray-900">Statistik Project</h2>
                        </div>

                        <div class="space-y-3">
                            <div class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-purple-700 font-medium">Total Foto</span>
                                    <span class="text-2xl font-bold text-purple-700">{{ $project['photos_count'] }}</span>
                                </div>
                            </div>
                            
                            <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-green-700 font-medium">Teknologi</span>
                                    <span class="text-2xl font-bold text-green-700">{{ count(explode(',', $project['project_technology'])) }}</span>
                                </div>
                            </div>

                            <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-blue-700 font-medium">Durasi (bulan)</span>
                                    <span class="text-2xl font-bold text-blue-700">{{ $project['project_duration'] }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
